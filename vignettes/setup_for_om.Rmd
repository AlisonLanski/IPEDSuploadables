...
#read in with readr
specs_OM <- readr::read_csv(here::here("vignettes", "OM_Variable_Definitions - Sheet1.csv"))
#then run 
use_data(specs_OM, specs_OM, overwrite = TRUE) #to save as .rda and replace the old file
