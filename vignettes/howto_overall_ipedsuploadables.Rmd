...
Completions, 12 Month Enrollment, and Fall Enrollment still DO require reporting on "unknown gender". This means you continue to need the `GenderDetail` column, but should limit yourself to values of 1, 2, and 3 (anything other than 1 and 2 will be recoded to 3 within the package). Graduation Rates and other surveys continue to have no gender detail reporting.    
