...
#> Uploadable results available at C:/Users/alanski/AppData/Local/Temp/RtmpuCaqv0/12MonthEnrollment_AllParts_2026-02-02.txt

#one part, as csv instead of key-value file
produce_e1d_report(e1d_students, part = "A", format = "readable")
#> Readable results available at  C:/Users/alanski/AppData/Local/Temp/RtmpuCaqv0/12MonthEnrollment_PartA_Readable_2026-02-02.csv
# }
```
